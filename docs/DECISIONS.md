...
- **Integrity decision:** `tools/verify-runtime-assets.mjs` verifies JPEG signatures and exact SHA-256 values for the three runtime maps. The LFS-governed paths remain subject to `git lfs fsck` during CI and Pages publication.
