...
## ADR-082: Bound Hyper-Drive Rocket to legal six-second catch-up autopilot (proposed)

- **Date:** 2026-09-17.
- **Status:** **PROPOSED GOVERNANCE SCOPE.** Gameplay, VFX, audio, and presentation implementation are not authorized by this checkpoint.
- **Approval to begin checkpoint:** Manny approved beginning the next bounded Hyper-Drive Rocket governance checkpoint after Nitro Overdrive live acceptance. Scope review, publication, and implementation remain separate approval gates.
...
- **Boundary:** This proposal changes no selector probabilities, gap factor, accepted item behavior, AI acquisition/selection/tactical use, projectile behavior beyond the existing boundary, dependencies, binary assets, issue #106, or Slice 6 scope. It does not authorize Hyper-Drive gameplay, VFX, audio, or presentation implementation.
