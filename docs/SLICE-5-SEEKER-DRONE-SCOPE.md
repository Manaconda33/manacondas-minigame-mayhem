...
| Closing speed | Start at **42 m/s**. Desired speed is `clamp(target planar speed + 10 m/s, 42, 56 m/s)`, approached with a maximum speed-change rate of **20 m/s²**. No inherited launch-speed addition. These are approved initial balance values; live acceptance remains pending. |
