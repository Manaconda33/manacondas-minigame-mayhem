...
- **Date:** 2026-09-19.
- **Status:** **APPROVED FOR IMPLEMENTATION / FEATURE-BRANCH CHECKPOINT; PUBLICATION AND DEPLOYED VISUAL ACCEPTANCE PENDING.**
...
- **Baseline publication evidence:** The bounded baseline merged through PR #185 at `300a4d5d174e962d6ef4db19dcbee3184bc22202`; post-merge validation and GitHub Pages run `35410777878` passed. Manny's deployed review found a bounded driver-art/kart-preview overlap, so visual acceptance remains open while the responsive lane correction is reviewed.
- **Preserved boundaries:** No race HUD, mini-map, pause menu, Results/podium, race/engine/final-lap audio, post-processing, PBR/material, Circuit Alpha topology, racer statistics, item behavior/probability, AI tactics, avatar likeness, kart identity/geometry, Candidate B experiments, hosting architecture, or later Slice 6 work is authorized by this ADR. Stop at Manny's deployed Character Select visual-acceptance gate.


## ADR-091: Add approved full-body selection art without changing race assets

- **Date:** 2026-09-19.
- **Status:** **APPROVED ASSET PACKAGE / FEATURE-BRANCH INTEGRATION; PUBLICATION AND DEPLOYED VISUAL ACCEPTANCE PENDING.**
...
- **Evidence:** The mapping and source/runtime hashes are recorded in `docs/assets/CHARACTER-SELECT-FULL-BODY-ASSET-BRIEF.md` and `docs/ASSET-PROVENANCE.md`; active avatar records and `docs/ROSTER-MAPPING.md` record the selection-only allocation. Publication follows the normal PR, hosted CI, and Pages workflow, then stops at Manny's deployed desktop/mobile Character Select visual-acceptance gate.

## ADR-092: Deliver Character Select full-body art as normal-Git runtime derivatives
