export function touchControlsMarkup(enabled: boolean): string {
  ...
  return `<div id="touch-controls" class="touch-controls" aria-label="Touch driving controls">
    <div class="touch-cluster steering-controls"><button id="mobile-steering-wheel" class="touch-steering-wheel" aria-label="Steering wheel. Hold and drag left or right to steer; holding also accelerates." type="button"><span aria-hidden="true">◉</span></button></div>
