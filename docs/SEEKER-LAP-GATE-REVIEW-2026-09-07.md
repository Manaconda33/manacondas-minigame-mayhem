...
Accepted production behavior remains PR #108 gameplay, with CI/Pages evidence above. Issue #106 stays deferred. The next proposed Apex core scope is in `docs/SLICE-5-APEX-MISSILE-SCOPE.md`; its new fill-ins require scope approval before implementation. Slice 6 remains locked.
