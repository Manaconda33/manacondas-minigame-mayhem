...
export class KartTimeTrial {
  ...
  private updateOpponents(dt: number): void {
    ...
    const playerRaceCompletion = executionAssistRaceCompletion(playerTotal);
  ...
  private createOpponents(spawn: THREE.Vector3, tangent: THREE.Vector3, yaw: number): void {
    ...
    for (let index = 0; index < 7; index += 1) {
      ...
      const basePace = 0.28 + index * 0.09;
      ...
      this.opponents.push({
        ...
        basePace,
        executionAssist: new AiExecutionAssist(),
