...
- Runtime asset: `public/assets/characters/aa-08/results/reaction.png`.
- Approval: Manny approved the chroma-green render and true-alpha cutout on 2026-09-25. Pose: Wry recovery shrug and hand to beanie.
